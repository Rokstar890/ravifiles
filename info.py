...
BOT_TOKEN = environ.get('BOT_TOKEN', "6004181097:AAFWlyneOxtvpQ0_REE93ce1ksQTutRTs7k")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6683865620').split()]
